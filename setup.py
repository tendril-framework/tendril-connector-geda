...
setup(
    ...
    description="gEDA connector for tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-connector-geda',
        project_urls={
        'Documentation': 'https://tendril-eda.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-eda/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-eda',
    },
